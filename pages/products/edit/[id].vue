    ...
    <form @submit.prevent="updateProduct">
      <div class="grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
        ...
        <div class="sm:col-span-3">
          ...
          <input v-model="product.name" type="text" id="product-name" class="mt-2 block w-full px-4 py-2 border rounded-md" required>
        </div>

        <!-- Category -->
        <div class="sm:col-span-3">
          <label for="category" class="block text-lg font-medium text-gray-700">Category</label>
          <select v-model="product.category_id" id="category" class="mt-2 block w-full px-4 py-2 border rounded-md" required>
        ...
        <div class="sm:col-span-3">
          ...
          <input v-model="product.sku" type="text" id="sku" class="mt-2 block w-full px-4 py-2 border rounded-md" required>
        </div>

        <!-- Price -->
        <div class="sm:col-span-3">
          <label for="price" class="block text-lg font-medium text-gray-700">Price</label>
          <input v-model="product.price" type="number" id="price" class="mt-2 block w-full px-4 py-2 border rounded-md" required min="0">
        </div>

        <!-- Initial Stock Quantity -->
        <div class="sm:col-span-3">
          <label for="initial-stock" class="block text-lg font-medium text-gray-700">Initial Stock</label>
          <input v-model="product.initial_stock_quantity" type="number" id="initial-stock" class="mt-2 block w-full px-4 py-2 border rounded-md" required min="0">
        </div>
