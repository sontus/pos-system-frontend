...
<template>
    <div class="bg-white p-6 rounded-lg shadow-md">
        <div class="flex justify-between items-center mb-6">
            ...
            <NuxtLink to="/products/create" class="bg-blue-800 text-white px-4 py-2 rounded-md hover:bg-blue-700">Add
                Product</NuxtLink>
        </div>
        ...
        <table class="min-w-full table-auto text-left">
            ...
            <tbody>
                <tr v-for="(product, index) in products" :key="product.product_id" class="border-t">
                    ...
                    <td class="py-3 px-4">
                        <NuxtLink :to="`/products/edit/${product.product_id}`"
        ...
        <div class="mt-6 flex justify-between items-center">
            ...
            <button :disabled="currentPage === lastPage" @click="fetchProducts(currentPage + 1)"
                class="bg-blue-600 text-white px-4 py-2 rounded-md hover:bg-blue-700 disabled:opacity-50">
                Next
            </button>
        </div>
